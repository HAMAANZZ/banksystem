...
public class PrivateBank implements Bank {
    ...
    public List<Transaction> getTransactionsSorted(String account, boolean asc) {
        ...
        return transactions; // Sortierte Liste zurückgeben
    }
    ...
    public List<Transaction> getTransactionsByType(String account, boolean positive) {
        ...
        // Filtern der Transaktionen
        List<Transaction> transactions = accountsToTransactions.get(account);
        return transactions.stream()
                .filter(t -> positive ? t.getAmount() > 0 : t.getAmount() < 0)
                .toList(); // Rückgabe der gefilterten Liste
    }
